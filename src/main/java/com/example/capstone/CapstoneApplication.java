		...
		return args -> {
			List<InteriorStyle> defaultStyles = Arrays.asList(
					...
					InteriorStyle.builder()
							...
							.tips(Arrays.asList(
									"- 깔끔한 공간 유지를 위해 불필요한 물건을 제거하고 꼭 필요한 아이템만 남겨두세요!",
									"- 장식이 적고 깔끔한 선이 돋보이는 가구로 선택! 과도한 장식은 NO!",
									"- 창문을 통해 들어오는 자연광을 최대한 활용! 커튼은 가볍고 투명한 소재로 선택하세요.",
					...
					InteriorStyle.builder()
							...
							.tips(Arrays.asList(
									"- 내추럴은 곧 디테일입니다. 가구, 소품, 조명의 교체만으로도 효과 UP",
									"- 공간을 더 밝고 생기 있게 끌어올리기 위한 식물 배치는 200% 필요!",
									"- 디자인이나 무늬가 과하거나 튀는 제품은 자제하시는 게 좋아요",
									"- 전체적인 컬러는 산뜻하고 밝은 색으로 가고 무겁거나 튀는 느낌은 최대한 절제!"
							))
							.color(Arrays.asList(
					...
					InteriorStyle.builder()
							...
							.tips(Arrays.asList(
									"- 부드러운 색상 팔레트 사용! 핑크, 크림 등의 색상을 사용해 로맨틱한 분위기 UP",
									"- 플로럴 패턴으로 공간에 생기를 더하고 촉감이 좋은 패브릭을 선택하여 포근한 분위기 연출 가능!",
									"- 곡선미가 돋보이는 우아한 가구를 선택하세요. 곡선형 헤드보드가 있는 침대 추천!",
									"- 따뜻한 색상의 조명은 로맨틱한 분위기를 만드는 데 중요한 요소! 캔들 라이트 활용하기!"
							))
							.color(Arrays.asList(
					...
					InteriorStyle.builder()
							...
							.tips(Arrays.asList(
									...
									"- 따뜻한 색상을 사용하여 공간을 아늑하게 만들기! 복고풍의 분위기 연출 가능!",
									"- 빈티지 라디오, 레코드 플레이어 등 레트로 느낌의 액세서리와 장식품을 활용하여 레트로 감성 UP",
									"- 다양한 소재를 믹스 매치하여 독특한 빈티지 스타일을 연출해 보세요."
							))
							.color(Arrays.asList(
